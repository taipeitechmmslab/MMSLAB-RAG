...
程式流程：
  1. stream_agent() 建立 Agent、送出讀者問題並回傳原始串流資料。
  2. _iter_messages() 從原始串流資料中取出 AIMessage 與 ToolMessage。
...
def run_agentic_rag(query: str) -> Iterator[dict]:
    try:
        ...
        # 從原始串流資料中取出 AIMessage 與 ToolMessage。
